package  
{
	...
	public class MainMenu extends FlxState
	{
		...
		private function init():void
		{
			...
			credits.add(new FlxText(Main.WIDTH / 2 - 100, Main.HEIGHT / 2 + 50, 250, "Powered by Flixel."));
			credits.add(new FlxText(Main.WIDTH / 2 - 100, Main.HEIGHT / 2 + 70, 250, "Sounds generated by sfxr."));
			credits.add(new FlxText(Main.WIDTH / 2 - 100, Main.HEIGHT / 2 + 90, 250, "Press Escape to Return to the Main Menu."));
